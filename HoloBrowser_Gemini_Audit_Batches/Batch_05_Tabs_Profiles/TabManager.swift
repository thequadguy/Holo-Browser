...
public final class TabManager: ObservableObject {
    ...
    public func setup(dataStore: WKWebsiteDataStore) {
        guard tabs.isEmpty else { return }
        createNewTab(url: URL(string: "https://apple.com")!, dataStore: dataStore)
    }
    ...
    public func closeTab(id: UUID, currentProfileID: UUID = UUID()) {
