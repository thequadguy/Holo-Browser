...
public final class AIPrivacyManager: ObservableObject {
    ...
    /// Mandatory AI Privacy Pipeline: sanitizes all text data before sending to any cloud AI provider.
    /// Removes passwords, authorization headers, cookies, JWTs, OAuth tokens, API keys, private keys, credit cards, and sensitive parameters.
